...
class FreezeTimeMainPage extends Page
{
    ...
    {
        $day = Item::get(Block::WOOL, Wool::CYAN)->setCustomName('§r§bDia');
        $midday = Item::get(Block::WOOL, Wool::YELLOW)->setCustomName('§r§6Meio-dia');
        $night = Item::get(Block::WOOL, Wool::BLACK)->setCustomName('§r§7Noite');
